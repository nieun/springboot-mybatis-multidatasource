...
@Configuration
@Import(SlaveDBConfig.MyBatisConfig.class)
public class SlaveDBConfig {
    static final String NAME = "slave";
    ...
    @Configuration
    @MapperScan(basePackageClasses = SlaveDBConfig.class, sqlSessionFactoryRef = SQL_SESSION_FACTORY, sqlSessionTemplateRef = SQL_SESSION_TEMPLATE)
